...
\SVN$Rev: 5852 $
\SVN$Date: 2020-07-21 13:11:45 +0200 (ar., 21 uzt 2020) $
\SVN$URL: https://volute.g-vo.org/svn/trunk/projects/dal/udf-catalogue/udf-catalogue.tex $
...
{\begin{html}<ul>\end{html}%
  ...
  \def\becomes{ returns }%
  \def\done##1.{\begin{html})</code>\end{html} ##1\begin{html}</li>\end{html}}}%
{\begin{html}</ul>\end{html}}
...
\becomes undefined
\done Implementations are adivsed to fail when floating point numbers
...
For that very reason it is neither precise nor fast.
