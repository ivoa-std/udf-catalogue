...
\subsection{epoch\_prop\_pos(ra, dec, parallax, pmra, pmdec,
...
the temporal derivative of the longitude mulitplied by the cosine or the
...
\arg radial\_velocity (REAL) -- the object's radial veloity at
...
\subsection{epoch\_prop(ra, dec, parallax, pmra, pmdec,
  radial\_velocity, ref\_epoch, out\_epoch)}
